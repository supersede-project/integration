...
public class HttpMonitorProxyTest_Ampl4 {
    private static HttpMonitorProxy<?, ?> proxy;

    @BeforeClass
    public static void setup() throws Exception {
        HttpMonitorProxyTest_Ampl4.proxy = new HttpMonitorProxy<Object, Object>();
    }
    ...
    public void testCreateAndDeleteMonitorConfiguration() throws Exception {
        ...
        HttpMonitorConfiguration result = HttpMonitorProxyTest_Ampl4.proxy.createMonitorConfiguration(conf);
        Assert.notNull(result);
        Assert.isTrue(((result.getId()) > 0));
        org.junit.Assert.assertEquals(HttpMonitorProxyTest_Ampl4.proxy.deleteMonitorConfiguration(conf), HttpStatus.OK);
    }
    ...
    public void testCreateAndDeleteMonitorConfigurationMultipart() throws Exception {
        ...
        HttpMonitorConfiguration result = HttpMonitorProxyTest_Ampl4.proxy.createMonitorConfiguration(conf, file);
        Assert.notNull(result);
        Assert.isTrue(((result.getId()) > 0));
        HttpStatus o_testCreateAndDeleteMonitorConfigurationMultipart__11 = HttpMonitorProxyTest_Ampl4.proxy.deleteMonitorConfiguration(conf);
    ...
    public void testCreateAndDeleteMonitorConfigurationMultipart_add1() throws Exception {
        ...
        Assert.notNull(result);
        Assert.isTrue(((result.getId()) > 0));
        HttpStatus o_testCreateAndDeleteMonitorConfigurationMultipart_add1__12 = HttpMonitorProxyTest_Ampl4.proxy.deleteMonitorConfiguration(conf);
    ...
    public void testCreateAndDeleteMonitorConfigurationMultipart_literalMutationString12_failAssert0() throws Exception {
        try {
            ...
            Assert.notNull(result);
            Assert.isTrue(((result.getId()) > 0));
            HttpMonitorProxyTest_Ampl4.proxy.deleteMonitorConfiguration(conf);
    ...
    public void testCreateAndDeleteMonitorConfigurationMultipartnull62_failAssert0() throws Exception {
        try {
            HttpMonitorConfiguration conf = createMonitorConfiguration();
            Path file = FileSystems.getDefault().getPath("src/test/resources/files", "list1s.txt");
            HttpMonitorConfiguration result = HttpMonitorProxyTest_Ampl4.proxy.createMonitorConfiguration(null, file);
            Assert.notNull(result);
            Assert.isTrue(((result.getId()) > 0));
            HttpMonitorProxyTest_Ampl4.proxy.deleteMonitorConfiguration(conf);
    ...
    public void testCreateAndDeleteMonitorConfigurationMultipartnull63_failAssert0() throws Exception {
        try {
            HttpMonitorConfiguration conf = createMonitorConfiguration();
            Path file = FileSystems.getDefault().getPath("src/test/resources/files", "list1s.txt");
            HttpMonitorConfiguration result = HttpMonitorProxyTest_Ampl4.proxy.createMonitorConfiguration(conf, null);
            Assert.notNull(result);
            Assert.isTrue(((result.getId()) > 0));
            HttpMonitorProxyTest_Ampl4.proxy.deleteMonitorConfiguration(conf);
    ...
    public void testUpdateMonitorConfiguration() throws Exception {
        ...
        result = HttpMonitorProxyTest_Ampl4.proxy.updateMonitorConfiguration(result);
        Assert.notNull(result);
