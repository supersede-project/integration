...
public class ModelRepositoryProxyTest {
    ...
    public void testGetAllAdaptationModels_add4523() throws Exception {
        List<IModel> o_testGetAllAdaptationModels_add4523__1 = ModelRepositoryProxyTest.proxy.getModelInstances(ModelType.BaseModel, ModelSystem.Atos_HSK, null);
    ...
    public void testGetAllFCModels_add10106() throws Exception {
        List<IModel> o_testGetAllFCModels_add10106__1 = ModelRepositoryProxyTest.proxy.getModelInstances(ModelType.FeatureConfiguration, ModelSystem.Atos_HSK, null);
    ...
    public void testGetAllBaseModels_add4626() throws Exception {
        List<IModel> o_testGetAllBaseModels_add4626__1 = ModelRepositoryProxyTest.proxy.getModelInstances(ModelType.BaseModel, null, null);
    ...
    public void testGetAllBaseModels_add4630() throws Exception {
        ...
        Assert.notEmpty(result);
        Collections.sort(result);
        IModel o_testGetAllBaseModels_add4630__6 = ModelRepositoryProxyTest.proxy.getModelInstance(ModelType.BaseModel, result.get(0).getValue("id").toString());
    ...
    public void testGetAllBaseModels_add4626_add4846litString6181_failAssert0() throws Exception {
        try {
            ...
            Assert.notEmpty(result);
            Collections.sort(result);
            IModel o_testGetAllBaseModels_add4626_add4846__9 = ModelRepositoryProxyTest.proxy.getModelInstance(ModelType.BaseModel, result.get(0).getValue("id").toString());
    ...
    public void testGetAllBaseModels_add4626_add4846litString6236_failAssert0() throws Exception {
        try {
            ...
            Assert.notEmpty(result);
            Collections.sort(result);
            IModel o_testGetAllBaseModels_add4626_add4846__9 = ModelRepositoryProxyTest.proxy.getModelInstance(ModelType.BaseModel, result.get(0).getValue("dependencies").toString());
            IModel model = ModelRepositoryProxyTest.proxy.getModelInstance(ModelType.BaseModel, result.get(0).getValue("id").toString());
            Assert.notNull(model);
    ...
    public void testGetAllBaseModelsWithQueryMetadata_add6674() throws Exception {
        ...
        Object o_testGetAllBaseModelsWithQueryMetadata_add6674__3 = ModelRepositoryProxyTest.baseModel.getValue("authorId");
    ...
    public void testGetAllBaseModelsWithQueryMetadata_add6679() throws Exception {
        ...
        Assert.notEmpty(result);
        Collections.sort(result);
        IModel o_testGetAllBaseModelsWithQueryMetadata_add6679__10 = ModelRepositoryProxyTest.proxy.getModelInstance(ModelType.BaseModel, result.get(0).getValue("id").toString());
    ...
    public void testGetAllBaseModelsWithQueryMetadata_literalMutationString6690_failAssert0() throws Exception {
        try {
            BaseModel metadata = new BaseModel();
            metadata.setAuthorId(((String) (ModelRepositoryProxyTest.baseModel.getValue("auWthorId"))));
            List<IModel> result = ModelRepositoryProxyTest.proxy.getModelInstances(ModelType.BaseModel, metadata);
            Assert.notNull(result);
            Assert.notEmpty(result);
            Collections.sort(result);
    ...
    public void testGetAllBaseModelsWithQueryMetadatalitString6733_failAssert0() throws Exception {
        try {
            BaseModel metadata = new BaseModel();
            metadata.setAuthorId(((String) (ModelRepositoryProxyTest.baseModel.getValue("creationDate"))));
            List<IModel> result = ModelRepositoryProxyTest.proxy.getModelInstances(ModelType.BaseModel, metadata);
            Assert.notNull(result);
            Assert.notEmpty(result);
            Collections.sort(result);
    ...
    public void testGetAllBaseModelsWithQueryMetadata_add6674litString7468_failAssert0() throws Exception {
        try {
            BaseModel metadata = new BaseModel();
            Object o_testGetAllBaseModelsWithQueryMetadata_add6674__3 = ModelRepositoryProxyTest.baseModel.getValue("authorId");
            metadata.setAuthorId(((String) (ModelRepositoryProxyTest.baseModel.getValue("r|/$GFAA"))));
            List<IModel> result = ModelRepositoryProxyTest.proxy.getModelInstances(ModelType.BaseModel, metadata);
            Assert.notNull(result);
            Assert.notEmpty(result);
            Collections.sort(result);
