...
public class ReplanControllerProxyTest {
    ...
    public static void setup() throws Exception {
        ...
        boolean result = ReplanControllerProxyTest.proxy.addReleaseOfProjectById(release, ReplanControllerProxyTest.projectId);
    ...
    public static void cleanup() throws Exception {
        Assert.isTrue(ReplanControllerProxyTest.proxy.deleteSkillByIdOfProjectById(ReplanControllerProxyTest.skillId, ReplanControllerProxyTest.projectId));
        Assert.isTrue(ReplanControllerProxyTest.proxy.deleteFeatureByIdOfProjectById(ReplanControllerProxyTest.featureId, ReplanControllerProxyTest.projectId));
        Assert.isTrue(ReplanControllerProxyTest.proxy.deleteResourceByIdOfProjectById(ReplanControllerProxyTest.resourceId, ReplanControllerProxyTest.projectId));
        Assert.isTrue(ReplanControllerProxyTest.proxy.deleteReleaseByIdOfProjectById(ReplanControllerProxyTest.releaseId, ReplanControllerProxyTest.projectId));
        Assert.isTrue(ReplanControllerProxyTest.proxy.deleteProjectById(ReplanControllerProxyTest.projectId));
    }
    ...
    public void testGetFeaturesOfProjectById_add34322() throws Exception {
        List<Feature> o_testGetFeaturesOfProjectById_add34322__1 = ReplanControllerProxyTest.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest.projectId);
    ...
    public void testGetFeaturesOfProjectById_add34325() throws Exception {
        ...
        Assert.notEmpty(features);
        Assert.notEmpty(features);
        List<Feature> o_testGetFeaturesOfProjectById_add34325__5 = ReplanControllerProxyTest.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest.projectId, FeatureStatus.PENDING);
    ...
    public void testGetFeatureByIdOfProjectById_add33575() throws Exception {
        List<Feature> o_testGetFeatureByIdOfProjectById_add33575__1 = ReplanControllerProxyTest.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest.projectId);
    ...
    public void testGetReleaseByIdOfProjectById_add36261() throws Exception {
        List<Release> o_testGetReleaseByIdOfProjectById_add36261__1 = ReplanControllerProxyTest.proxy.getReleasesOfProjectById(ReplanControllerProxyTest.projectId);
    ...
    public void testGetFeaturesOfReleaseByIdOfProjectById_add34687() throws Exception {
        List<Release> o_testGetFeaturesOfReleaseByIdOfProjectById_add34687__1 = ReplanControllerProxyTest.proxy.getReleasesOfProjectById(ReplanControllerProxyTest.projectId);
    ...
    public void testGetPlanOfReleaseByIdOfProjectById_add35136() throws Exception {
        List<Release> o_testGetPlanOfReleaseByIdOfProjectById_add35136__1 = ReplanControllerProxyTest.proxy.getReleasesOfProjectById(ReplanControllerProxyTest.projectId);
            ...
            {
                {
                    ...
                    List<Release> releases = ReplanControllerProxyTest.proxy.getReleasesOfProjectById(ReplanControllerProxyTest.projectId);
                    Assert.notEmpty(releases);
                    Plan plan = ReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(40).getId(), ReplanControllerProxyTest.projectId);
                    Assert.notNull(null);
                    org.junit.Assert.fail("testGetPlanOfReleaseByIdOfProjectByIdnull35168 should have thrown IllegalArgumentException");
                    plan.setJobs(__DSPOT_jobs_961);
                }
    ...
    public void testCreateAndDeleteProject_add18038() throws Exception {
        Project o_testCreateAndDeleteProject_add18038__1 = ReplanControllerProxyTest.createProject();
        ...
        Assert.notNull(project);
        Assert.notNull(project.getId());
        Assert.isTrue(ReplanControllerProxyTest.proxy.deleteProjectById(project.getId()));
        assertEquals(40.0, ((double) (((Project) (o_testCreateAndDeleteProject_add18038__1)).getHoursPerWeekFullTimeResource())), 0.1);
        assertEquals("hour", ((Project) (o_testCreateAndDeleteProject_add18038__1)).getEffortUnit());
        assertEquals(1.0, ((double) (((Project) (o_testCreateAndDeleteProject_add18038__1)).getHoursPerEffortUnit())), 0.1);
        assertTrue(((Collection) (((Project) (o_testCreateAndDeleteProject_add18038__1)).getResources())).isEmpty());
    ...
    public void testCreateAndDeleteFeatureForProject_add16143() throws Exception {
        Project o_testCreateAndDeleteFeatureForProject_add16143__1 = ReplanControllerProxyTest.createProject();
        ...
        Assert.notNull(feature);
        Assert.notNull(feature.getId());
        Assert.isTrue(ReplanControllerProxyTest.proxy.deleteFeatureByIdOfProjectById(feature.getId(), project.getId()));
        Assert.isTrue(ReplanControllerProxyTest.proxy.deleteProjectById(project.getId()));
        assertEquals(40.0, ((double) (((Project) (o_testCreateAndDeleteFeatureForProject_add16143__1)).getHoursPerWeekFullTimeResource())), 0.1);
        assertEquals("hour", ((Project) (o_testCreateAndDeleteFeatureForProject_add16143__1)).getEffortUnit());
        assertEquals(1.0, ((double) (((Project) (o_testCreateAndDeleteFeatureForProject_add16143__1)).getHoursPerEffortUnit())), 0.1);
    ...
    public void testUpdateProject_add37159() throws Exception {
        Project o_testUpdateProject_add37159__1 = ReplanControllerProxyTest.createProject();
    ...
    public void testUpdateSkillsOfProjectById_add41235() throws Exception {
        List<Skill> o_testUpdateSkillsOfProjectById_add41235__1 = ReplanControllerProxyTest.proxy.getSkillsOfProjectById(ReplanControllerProxyTest.projectId);
    ...
    public void testUpdateResourceOfProjectById_add39985() throws Exception {
        List<Resource> o_testUpdateResourceOfProjectById_add39985__1 = ReplanControllerProxyTest.proxy.getResourcesOfProjectById(ReplanControllerProxyTest.projectId);
    ...
    public void testAddDeleteSkillsOfFeatureByIdOfProjectById_add12411() throws Exception {
        List<Skill> o_testAddDeleteSkillsOfFeatureByIdOfProjectById_add12411__1 = ReplanControllerProxyTest.proxy.getSkillsOfProjectById(ReplanControllerProxyTest.projectId);
    ...
    public void testAddDeleteDependenciesOfFeatureByIdOfProjectById_add1954() throws Exception {
        List<Feature> o_testAddDeleteDependenciesOfFeatureByIdOfProjectById_add1954__1 = ReplanControllerProxyTest.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest.projectId);
    ...
    public void testAddDeleteDependenciesOfFeatureByIdOfProjectById_mg1993_literalMutationNumber2407_failAssert0() throws Exception {
        try {
            ...
            Assert.notNull(feature);
            Assert.notNull(feature);
            feature = ReplanControllerProxyTest.proxy.deleteDependenciesOfFeatureByIdOfProjectById(dependencies, features.get(40).getId(), ReplanControllerProxyTest.projectId);
            feature.setRequiredSkills(__DSPOT_requiredSkills_30);
    ...
    public void testAddDeleteDependenciesOfFeatureByIdOfProjectById_mg1993litNum2530_failAssert0() throws Exception {
        try {
            ...
            List<Feature> dependencies = new ArrayList<>();
            boolean o_testAddDeleteDependenciesOfFeatureByIdOfProjectById_mg1993__10 = dependencies.add(features.get(0));
            Feature feature = ReplanControllerProxyTest.proxy.addDependenciesOfFeatureByIdOfProjectById(dependencies, features.get(Integer.MIN_VALUE).getId(), ReplanControllerProxyTest.projectId);
            Assert.notNull(feature);
            Assert.notNull(feature);
            feature = ReplanControllerProxyTest.proxy.deleteDependenciesOfFeatureByIdOfProjectById(dependencies, features.get(0).getId(), ReplanControllerProxyTest.projectId);
            feature.setRequiredSkills(__DSPOT_requiredSkills_30);
    ...
    public void testAddDeleteResourcesOfReleaseByIdOfProjectById_add8629() throws Exception {
        List<Resource> o_testAddDeleteResourcesOfReleaseByIdOfProjectById_add8629__1 = ReplanControllerProxyTest.proxy.getResourcesOfProjectById(ReplanControllerProxyTest.projectId);
    ...
    public void testAddDeleteFeaturesOfReleaseByIdOfProjectById_add4266() throws Exception {
        List<Feature> o_testAddDeleteFeaturesOfReleaseByIdOfProjectById_add4266__1 = ReplanControllerProxyTest.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest.projectId);
        ...
        boolean result = ReplanControllerProxyTest.proxy.addFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest.projectId);
        Assert.isTrue(result);
        Assert.isTrue(result);
        result = ReplanControllerProxyTest.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest.projectId);
        assertFalse(o_testAddDeleteFeaturesOfReleaseByIdOfProjectById_add4266__1.isEmpty());
        assertTrue(o_testAddDeleteFeaturesOfReleaseByIdOfProjectById_add4266__12);
    }
    ...
    public void testAddDeleteFeaturesOfReleaseByIdOfProjectById_literalMutationNumber4299_failAssert0() throws Exception {
        try {
            ...
            Assert.isTrue(result);
            Assert.isTrue(result);
            result = ReplanControllerProxyTest.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(1).getId(), ReplanControllerProxyTest.projectId);
    ...
    public void testAddDeleteFeaturesOfReleaseByIdOfProjectByIdlitNum4318_failAssert0() throws Exception {
        try {
            ...
            Assert.isTrue(result);
            Assert.isTrue(result);
            result = ReplanControllerProxyTest.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(Integer.MAX_VALUE).getId(), ReplanControllerProxyTest.projectId);
    ...
    public void testAddDeleteFeaturesOfReleaseByIdOfProjectByIdnull4344_failAssert0() throws Exception {
        try {
            ...
            List<Feature> featuresToAdd = new ArrayList<>();
            featuresToAdd.add(features.get(0));
            boolean result = ReplanControllerProxyTest.proxy.addFeaturesOfReleaseByIdOfProjectById(null, releases.get(0).getId(), ReplanControllerProxyTest.projectId);
            Assert.isTrue(result);
            Assert.isTrue(result);
            result = ReplanControllerProxyTest.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest.projectId);
    ...
    public void testAddDeleteSkillOfProjectById_add10815() throws Exception {
        ...
        skill.setName("Atos test: Swift");
        skill.setDescription("Atos Test: Swift development of iOS");
        Skill o_testAddDeleteSkillOfProjectById_add10815__5 = ReplanControllerProxyTest.proxy.addSkillOfProjectById(skill, ReplanControllerProxyTest.projectId);
        ...
        skill = ReplanControllerProxyTest.proxy.addSkillOfProjectById(skill, ReplanControllerProxyTest.projectId);
        Assert.notNull(skill);
        boolean result = ReplanControllerProxyTest.proxy.deleteSkillByIdOfProjectById(skill.getId(), ReplanControllerProxyTest.projectId);
        Assert.isTrue(result);
        assertEquals("Atos Test: Swift development of iOS", ((Skill) (o_testAddDeleteSkillOfProjectById_add10815__5)).getDescription());
        assertEquals("Atos test: Swift", ((Skill) (o_testAddDeleteSkillOfProjectById_add10815__5)).getName());
    }
    ...
    public void testAddDeleteSkillsOfResourceByIdOfProjectById_add14036() throws Exception {
        List<Skill> o_testAddDeleteSkillsOfResourceByIdOfProjectById_add14036__1 = ReplanControllerProxyTest.proxy.getSkillsOfProjectById(ReplanControllerProxyTest.projectId);
    ...
    public void testDeleteFeaturesOfReleaseByIdOfProjectById_add23323() throws Exception {
        List<Feature> o_testDeleteFeaturesOfReleaseByIdOfProjectById_add23323__1 = ReplanControllerProxyTest.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest.projectId);
        ...
        result = ReplanControllerProxyTest.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToDelete, releases.get(0).getId(), ReplanControllerProxyTest.projectId);
    ...
    public void testDeleteFeaturesOfReleaseByIdOfProjectById_literalMutationNumber23386_failAssert0() throws Exception {
        try {
            ...
            result = ReplanControllerProxyTest.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToDelete, releases.get(-1).getId(), ReplanControllerProxyTest.projectId);
            featuresOfRelease = ReplanControllerProxyTest.proxy.getFeaturesOfReleaseByIdOfProjectById(releases.get(0).getId(), ReplanControllerProxyTest.projectId);
            Assert.isTrue(((featuresOfRelease.size()) == (numberOfFeaturesOfRelease - 1)));
    ...
    public void testDeleteFeaturesOfReleaseByIdOfProjectById_add23341_add23886() throws Exception {
        ...
        Assert.notEmpty(features);
        Assert.notEmpty(features);
        List<Release> o_testDeleteFeaturesOfReleaseByIdOfProjectById_add23341_add23886__5 = ReplanControllerProxyTest.proxy.getReleasesOfProjectById(ReplanControllerProxyTest.projectId);
    ...
    public void tesDeleteResourceOfProjectById_add4() throws Exception {
        ...
        resource.setDescription("Atos test: Swift developer with experience on iOS 10");
        resource.setAvailability(80.0);
        Resource o_tesDeleteResourceOfProjectById_add4__6 = ReplanControllerProxyTest.proxy.addResourceOfProjectById(resource, ReplanControllerProxyTest.projectId);
        ...
        resource = ReplanControllerProxyTest.proxy.addResourceOfProjectById(resource, ReplanControllerProxyTest.projectId);
        Assert.notNull(resource);
        boolean result = ReplanControllerProxyTest.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest.projectId);
        Assert.isTrue(result);
        assertTrue(((Collection) (((Resource) (o_tesDeleteResourceOfProjectById_add4__6)).getSkills())).isEmpty());
        assertEquals(80.0, ((double) (((Resource) (o_tesDeleteResourceOfProjectById_add4__6)).getAvailability())), 0.1);
        assertEquals("Atos test: Swift developer with experience on iOS 10", ((Resource) (o_tesDeleteResourceOfProjectById_add4__6)).getDescription());
    ...
    public void testDelecteSkillsOfResourceByIdOfProjectById_add18798() throws Exception {
        List<Skill> o_testDelecteSkillsOfResourceByIdOfProjectById_add18798__1 = ReplanControllerProxyTest.proxy.getSkillsOfProjectById(ReplanControllerProxyTest.projectId);
