...
public class IdentityManagerClientTest {
    ...
    public void testAuthenticateUserAccount_add4096() throws Exception {
        boolean o_testAuthenticateUserAccount_add4096__1 = IdentityManagerClientTest.usm.authenticate(IdentityManagerClientTest.admin, IdentityManagerClientTest.password);
    ...
    public void testAddUser_literalMutationString1881_failAssert0() throws Exception {
        try {
            ...
            claims.put(IdentityManagerClientTest.CLAIM_LAST_NAME_URI, "http://wso2.org/claims/organization");
            ...
            claims.put(IdentityManagerClientTest.CLAIM_COUNTRY_URI, "User Test country");
