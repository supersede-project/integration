...
public class ReplanControllerProxyTest_Ampl4 {
    private static final Logger log = LoggerFactory.getLogger(ReplanControllerProxyTest_Ampl4.class);
    ...
    public static void setup() throws Exception {
        ReplanControllerProxyTest_Ampl4.proxy = new ReplanControllerProxy();
        Project project = ReplanControllerProxyTest_Ampl4.createProject();
        project = ReplanControllerProxyTest_Ampl4.proxy.createProject(project);
        Assert.notNull(project);
        Assert.notNull(project.getId());
        ReplanControllerProxyTest_Ampl4.projectId = project.getId();
        ...
        resource = ReplanControllerProxyTest_Ampl4.proxy.addResourceOfProjectById(resource, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(resource);
        Assert.notNull(resource.getId());
        ReplanControllerProxyTest_Ampl4.resourceId = resource.getId();
        Feature feature = ReplanControllerProxyTest_Ampl4.createFeature();
        feature = ReplanControllerProxyTest_Ampl4.proxy.createFeatureOfProjectById(feature, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(feature);
        Assert.notNull(feature.getId());
        ReplanControllerProxyTest_Ampl4.featureId = feature.getId();
        Release release = ReplanControllerProxyTest_Ampl4.createRelease();
        org.junit.Assert.assertEquals(ReplanControllerProxyTest_Ampl4.proxy.addReleaseOfProjectById(release, ReplanControllerProxyTest_Ampl4.projectId), HttpStatus.OK);
        List<Release> releases = ReplanControllerProxyTest_Ampl4.proxy.getReleasesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notEmpty(releases);
        Assert.notNull(releases.get(0).getId());
        ReplanControllerProxyTest_Ampl4.releaseId = releases.get(0).getId();
        skill = ReplanControllerProxyTest_Ampl4.proxy.addSkillOfProjectById(skill, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(skill);
        ReplanControllerProxyTest_Ampl4.skillId = skill.getId();
    }

    @org.junit.AfterClass
    public static void cleanup() throws Exception {
        org.junit.Assert.assertEquals(ReplanControllerProxyTest_Ampl4.proxy.deleteSkillByIdOfProjectById(ReplanControllerProxyTest_Ampl4.skillId, ReplanControllerProxyTest_Ampl4.projectId), HttpStatus.OK);
        org.junit.Assert.assertEquals(ReplanControllerProxyTest_Ampl4.proxy.deleteFeatureByIdOfProjectById(ReplanControllerProxyTest_Ampl4.featureId, ReplanControllerProxyTest_Ampl4.projectId), HttpStatus.OK);
        org.junit.Assert.assertEquals(ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(ReplanControllerProxyTest_Ampl4.resourceId, ReplanControllerProxyTest_Ampl4.projectId), HttpStatus.OK);
        org.junit.Assert.assertEquals(ReplanControllerProxyTest_Ampl4.proxy.deleteReleaseByIdOfProjectById(ReplanControllerProxyTest_Ampl4.releaseId, ReplanControllerProxyTest_Ampl4.projectId), HttpStatus.OK);
        org.junit.Assert.assertEquals(ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(ReplanControllerProxyTest_Ampl4.projectId), HttpStatus.OK);
    }

    @Test(timeout = 30000)
    public void testGetAllProjectsnull35800_failAssert0() throws Exception {
        try {
            List<Project> projects = ReplanControllerProxyTest_Ampl4.proxy.getAllProjects();
            Assert.notNull(null);
    ...
    public void testGetProjectByIdnull38282_failAssert0() throws Exception {
        try {
            Project project = ReplanControllerProxyTest_Ampl4.proxy.getProjectById(ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notNull(null);
    ...
    public void testGetFeaturesOfProjectById_add36421() throws Exception {
        List<Feature> o_testGetFeaturesOfProjectById_add36421__1 = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        assertFalse(o_testGetFeaturesOfProjectById_add36421__1.isEmpty());
        List<Feature> features = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(features);
        Assert.notNull(features);
        Assert.notEmpty(features);
        Assert.notEmpty(features);
        features = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId, FeatureStatus.PENDING);
        assertFalse(o_testGetFeaturesOfProjectById_add36421__1.isEmpty());
    }
    ...
    public void testGetFeaturesOfProjectById_add36424() throws Exception {
        ...
        Assert.notEmpty(features);
        Assert.notEmpty(features);
        List<Feature> o_testGetFeaturesOfProjectById_add36424__5 = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId, FeatureStatus.PENDING);
    ...
    public void testGetFeatureByIdOfProjectById_add35846() throws Exception {
        List<Feature> o_testGetFeatureByIdOfProjectById_add35846__1 = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        assertFalse(o_testGetFeatureByIdOfProjectById_add35846__1.isEmpty());
        List<Feature> features = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notEmpty(features);
        Feature feature = ReplanControllerProxyTest_Ampl4.proxy.getFeatureByIdOfProjectById(features.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(feature);
        assertFalse(o_testGetFeatureByIdOfProjectById_add35846__1.isEmpty());
    }
    ...
    public void testGetReleaseByIdOfProjectById_add38364() throws Exception {
        List<Release> o_testGetReleaseByIdOfProjectById_add38364__1 = ReplanControllerProxyTest_Ampl4.proxy.getReleasesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        assertFalse(o_testGetReleaseByIdOfProjectById_add38364__1.isEmpty());
        List<Release> releases = ReplanControllerProxyTest_Ampl4.proxy.getReleasesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notEmpty(releases);
        Release release = ReplanControllerProxyTest_Ampl4.proxy.getReleaseByIdOfProjectById(releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testGetFeaturesOfReleaseByIdOfProjectById_add36786() throws Exception {
        List<Release> o_testGetFeaturesOfReleaseByIdOfProjectById_add36786__1 = ReplanControllerProxyTest_Ampl4.proxy.getReleasesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        assertFalse(o_testGetFeaturesOfReleaseByIdOfProjectById_add36786__1.isEmpty());
        List<Release> releases = ReplanControllerProxyTest_Ampl4.proxy.getReleasesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notEmpty(releases);
        List<Feature> features = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfReleaseByIdOfProjectById(releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(features);
        assertFalse(o_testGetFeaturesOfReleaseByIdOfProjectById_add36786__1.isEmpty());
    }
    ...
    public void testGetFeaturesOfReleaseByIdOfProjectById_literalMutationNumber36794_failAssert0() throws Exception {
        try {
            List<Release> releases = ReplanControllerProxyTest_Ampl4.proxy.getReleasesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notEmpty(releases);
            List<Feature> features = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfReleaseByIdOfProjectById(releases.get(1).getId(), ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notNull(features);
    ...
    public void testGetPlanOfReleaseByIdOfProjectById_add37235() throws Exception {
        List<Release> o_testGetPlanOfReleaseByIdOfProjectById_add37235__1 = ReplanControllerProxyTest_Ampl4.proxy.getReleasesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        assertFalse(o_testGetPlanOfReleaseByIdOfProjectById_add37235__1.isEmpty());
        List<Release> releases = ReplanControllerProxyTest_Ampl4.proxy.getReleasesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notEmpty(releases);
        Plan plan = ReplanControllerProxyTest_Ampl4.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(plan);
        assertFalse(o_testGetPlanOfReleaseByIdOfProjectById_add37235__1.isEmpty());
    }
        ...
        try {
            {
                ...
                List<Release> releases = ReplanControllerProxyTest_Ampl4.proxy.getReleasesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
                Assert.notEmpty(releases);
                Plan plan = ReplanControllerProxyTest_Ampl4.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(1).getId(), ReplanControllerProxyTest_Ampl4.projectId);
                Assert.notNull(plan);
    ...
    public void testCreateAndDeleteProject_add17365() throws Exception {
        Project o_testCreateAndDeleteProject_add17365__1 = ReplanControllerProxyTest_Ampl4.createProject();
        ...
        Assert.notNull(project);
        Assert.notNull(project.getId());
        HttpStatus o_testCreateAndDeleteProject_add17365__9 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
    ...
    public void testCreateAndDeleteProject_add17370() throws Exception {
        ...
        Assert.notNull(project);
        Assert.notNull(project.getId());
        HttpStatus o_testCreateAndDeleteProject_add17370__8 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
        ...
        HttpStatus o_testCreateAndDeleteProject_add17370__10 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
        ...
        try {
            {
                ...
                Assert.notNull(null);
                Assert.notNull(project.getId());
                ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
        ...
        try {
            {
                ...
                Project o_testCreateAndDeleteProject_add17365__1 = ReplanControllerProxyTest_Ampl4.createProject();
                Project project = ReplanControllerProxyTest_Ampl4.createProject();
                project = ReplanControllerProxyTest_Ampl4.proxy.createProject(null);
                Assert.notNull(project);
                Assert.notNull(project.getId());
                HttpStatus o_testCreateAndDeleteProject_add17365__9 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
    ...
    public void testCreateAndDeleteFeatureForProject_add15168() throws Exception {
        Project o_testCreateAndDeleteFeatureForProject_add15168__1 = ReplanControllerProxyTest_Ampl4.createProject();
        ...
        Assert.notNull(project.getId());
        Feature feature = ReplanControllerProxyTest_Ampl4.createFeature();
        feature = ReplanControllerProxyTest_Ampl4.proxy.createFeatureOfProjectById(feature, project.getId());
        Assert.notNull(feature);
        Assert.notNull(feature.getId());
        HttpStatus o_testCreateAndDeleteFeatureForProject_add15168__17 = ReplanControllerProxyTest_Ampl4.proxy.deleteFeatureByIdOfProjectById(feature.getId(), project.getId());
        ...
        HttpStatus o_testCreateAndDeleteFeatureForProject_add15168__20 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
    ...
    public void testCreateAndDeleteFeatureForProject_add15179() throws Exception {
        ...
        Assert.notNull(feature);
        Assert.notNull(feature.getId());
        HttpStatus o_testCreateAndDeleteFeatureForProject_add15179__16 = ReplanControllerProxyTest_Ampl4.proxy.deleteFeatureByIdOfProjectById(feature.getId(), project.getId());
        ...
        HttpStatus o_testCreateAndDeleteFeatureForProject_add15179__19 = ReplanControllerProxyTest_Ampl4.proxy.deleteFeatureByIdOfProjectById(feature.getId(), project.getId());
        assertNull(o_testCreateAndDeleteFeatureForProject_add15179__19);
        HttpStatus o_testCreateAndDeleteFeatureForProject_add15179__22 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
    ...
    public void testCreateAndDeleteFeatureForProject_mg15198() throws Exception {
        ...
        Assert.notNull(feature);
        Assert.notNull(feature.getId());
        HttpStatus o_testCreateAndDeleteFeatureForProject_mg15198__19 = ReplanControllerProxyTest_Ampl4.proxy.deleteFeatureByIdOfProjectById(feature.getId(), project.getId());
        ...
        HttpStatus o_testCreateAndDeleteFeatureForProject_mg15198__22 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
    ...
    public void testCreateAndDeleteFeatureForProject_add15174_failAssert0() throws Exception {
        try {
            ...
            Assert.notNull(project.getId());
            Feature feature = ReplanControllerProxyTest_Ampl4.createFeature();
            ReplanControllerProxyTest_Ampl4.proxy.createFeatureOfProjectById(feature, project.getId());
            feature = ReplanControllerProxyTest_Ampl4.proxy.createFeatureOfProjectById(feature, project.getId());
            Assert.notNull(feature);
            Assert.notNull(feature.getId());
            ReplanControllerProxyTest_Ampl4.proxy.deleteFeatureByIdOfProjectById(feature.getId(), project.getId());
            ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
    ...
    public void testCreateAndDeleteFeatureForProjectnull15201_failAssert0() throws Exception {
        try {
            ...
            Assert.notNull(project.getId());
            Feature feature = ReplanControllerProxyTest_Ampl4.createFeature();
            feature = ReplanControllerProxyTest_Ampl4.proxy.createFeatureOfProjectById(null, project.getId());
            Assert.notNull(feature);
            Assert.notNull(feature.getId());
            ReplanControllerProxyTest_Ampl4.proxy.deleteFeatureByIdOfProjectById(feature.getId(), project.getId());
            ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
    ...
    public void testAddFeaturesOfProjectById() throws Exception {
        ...
        features.add(ReplanControllerProxyTest_Ampl4.createFeatureWP3());
        ...
        ReplanControllerProxyTest_Ampl4.proxy.addFeaturesToProjectById(payload, 1);
    }
    ...
    public void testUpdateProject_add39335() throws Exception {
        Project o_testUpdateProject_add39335__1 = ReplanControllerProxyTest_Ampl4.createProject();
        ...
        project = ReplanControllerProxyTest_Ampl4.proxy.updateProject(project);
        HttpStatus o_testUpdateProject_add39335__14 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
    ...
    public void testUpdateProject_add39344() throws Exception {
        ...
        project.setDescription(((project.getDescription()) + " modified by test"));
        project = ReplanControllerProxyTest_Ampl4.proxy.updateProject(project);
        HttpStatus o_testUpdateProject_add39344__13 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
        ...
        HttpStatus o_testUpdateProject_add39344__15 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
    ...
    public void testUpdateProject_mg39359() throws Exception {
        ...
        project.setDescription(((project.getDescription()) + " modified by test"));
        project = ReplanControllerProxyTest_Ampl4.proxy.updateProject(project);
        HttpStatus o_testUpdateProject_mg39359__16 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
    ...
    public void testUpdateProject_mg39359_add39522() throws Exception {
        ...
        project.setDescription(((project.getDescription()) + " modified by test"));
        project = ReplanControllerProxyTest_Ampl4.proxy.updateProject(project);
        HttpStatus o_testUpdateProject_mg39359_add39522__16 = ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId());
    ...
    public void testUpdateFeatureOfProjectById() throws Exception {
        ...
        Assert.notNull(feature);
        Assert.notNull(feature.getId());
        List<Feature> features = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(project.getId());
        Assert.notEmpty(features);
        feature = ReplanControllerProxyTest_Ampl4.proxy.getFeatureByIdOfProjectById(features.get(0).getId(), project.getId());
        Assert.notNull(feature);
        feature.setDescription(((feature.getDescription()) + " modified by test"));
        ReplanControllerProxyTest_Ampl4.proxy.updateFeatureOfProjectById(feature, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(feature);
        org.junit.Assert.assertEquals(ReplanControllerProxyTest_Ampl4.proxy.deleteFeatureByIdOfProjectById(feature.getId(), project.getId()), HttpStatus.OK);
        org.junit.Assert.assertEquals(ReplanControllerProxyTest_Ampl4.proxy.deleteProjectById(project.getId()), HttpStatus.OK);
    }
    ...
    public void testUpdateReleasesOfProjectById_remove41040() throws Exception {
        ...
        release = ReplanControllerProxyTest_Ampl4.proxy.updateReleaseOfProjectById(release, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(release);
    ...
    public void testUpdateReleasesOfProjectByIdnull41070_failAssert0() throws Exception {
        try {
            ...
            String originalDescription = release.getDescription();
            release.setDescription(((release.getDescription()) + " modified by test"));
            release = ReplanControllerProxyTest_Ampl4.proxy.updateReleaseOfProjectById(null, ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notNull(release);
            Assert.notNull(release);
            release.setDescription(originalDescription);
            release = ReplanControllerProxyTest_Ampl4.proxy.updateReleaseOfProjectById(release, ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testUpdateSkillsOfProjectByIdlitNum43545() throws Exception {
        List<Skill> skills = ReplanControllerProxyTest_Ampl4.proxy.getSkillsOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        ...
        skill = ReplanControllerProxyTest_Ampl4.proxy.updateSkillOfProjectById(skill, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(skill);
        Assert.notNull(skill);
    ...
    public void testUpdateSkillsOfProjectByIdnull43556_failAssert0() throws Exception {
        try {
            ...
            String originalDescription = skill.getDescription();
            skill.setDescription(((skill.getDescription()) + " modified by test"));
            skill = ReplanControllerProxyTest_Ampl4.proxy.updateSkillOfProjectById(null, ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notNull(skill);
            Assert.notNull(skill);
            skill.setDescription(originalDescription);
            skill = ReplanControllerProxyTest_Ampl4.proxy.updateSkillOfProjectById(skill, ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testUpdateResourceOfProjectById_add42194() throws Exception {
        List<Resource> resources = ReplanControllerProxyTest_Ampl4.proxy.getResourcesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        ...
        resource.setDescription(((resource.getDescription()) + " modified by test"));
        resource = ReplanControllerProxyTest_Ampl4.proxy.updateResourceOfProjectById(resource, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(resource);
        Assert.notNull(resource);
    ...
    public void testUpdateResourceOfProjectByIdnull42235_failAssert0() throws Exception {
        try {
            ...
            String originalDescription = resource.getDescription();
            resource.setDescription(((resource.getDescription()) + " modified by test"));
            resource = ReplanControllerProxyTest_Ampl4.proxy.updateResourceOfProjectById(null, ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notNull(resource);
            Assert.notNull(resource);
            resource.setDescription(originalDescription);
            resource = ReplanControllerProxyTest_Ampl4.proxy.updateResourceOfProjectById(resource, ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteSkillsOfFeatureByIdOfProjectById_add11537() throws Exception {
        List<Skill> o_testAddDeleteSkillsOfFeatureByIdOfProjectById_add11537__1 = ReplanControllerProxyTest_Ampl4.proxy.getSkillsOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        ...
        List<Feature> features = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notEmpty(features);
        Feature feature = ReplanControllerProxyTest_Ampl4.proxy.addSkillsOfFeatureByIdOfProjectById(skills, features.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(feature);
        Assert.notNull(feature);
        feature = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillsOfFeatureByIdOfProjectById(skills, features.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteSkillsOfFeatureByIdOfProjectById_literalMutationNumber11555_failAssert0() throws Exception {
        try {
            ...
            List<Feature> features = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notEmpty(features);
            Feature feature = ReplanControllerProxyTest_Ampl4.proxy.addSkillsOfFeatureByIdOfProjectById(skills, features.get(1).getId(), ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notNull(feature);
            Assert.notNull(feature);
            feature = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillsOfFeatureByIdOfProjectById(skills, features.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteSkillsOfFeatureByIdOfProjectById_literalMutationNumber11560_failAssert0() throws Exception {
        try {
            ...
            Assert.notNull(feature);
            Assert.notNull(feature);
            feature = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillsOfFeatureByIdOfProjectById(skills, features.get(1).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteSkillsOfFeatureByIdOfProjectByIdnull11599_failAssert0() throws Exception {
        try {
            ...
            List<Feature> features = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notEmpty(features);
            Feature feature = ReplanControllerProxyTest_Ampl4.proxy.addSkillsOfFeatureByIdOfProjectById(null, features.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notNull(feature);
            Assert.notNull(feature);
            feature = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillsOfFeatureByIdOfProjectById(skills, features.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteDependenciesOfFeatureByIdOfProjectById_add1() throws Exception {
        List<Feature> o_testAddDeleteDependenciesOfFeatureByIdOfProjectById_add1__1 = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        ...
        Feature feature = ReplanControllerProxyTest_Ampl4.proxy.addDependenciesOfFeatureByIdOfProjectById(dependencies, features.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(feature);
        Assert.notNull(feature);
        feature = ReplanControllerProxyTest_Ampl4.proxy.deleteDependenciesOfFeatureByIdOfProjectById(dependencies, features.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        assertFalse(o_testAddDeleteDependenciesOfFeatureByIdOfProjectById_add1__1.isEmpty());
        assertTrue(o_testAddDeleteDependenciesOfFeatureByIdOfProjectById_add1__8);
    }
    ...
    public void testAddDeleteDependenciesOfFeatureByIdOfProjectById_literalMutationNumber29_failAssert0() throws Exception {
        try {
            ...
            Assert.notNull(feature);
            Assert.notNull(feature);
            feature = ReplanControllerProxyTest_Ampl4.proxy.deleteDependenciesOfFeatureByIdOfProjectById(dependencies, features.get(1).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteResourcesOfReleaseByIdOfProjectById_add7469() throws Exception {
        List<Resource> o_testAddDeleteResourcesOfReleaseByIdOfProjectById_add7469__1 = ReplanControllerProxyTest_Ampl4.proxy.getResourcesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        ...
        Release release = ReplanControllerProxyTest_Ampl4.proxy.addResourcesOfReleaseByIdOfProjectById(resourcesToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(release);
        Assert.notNull(release);
        release = ReplanControllerProxyTest_Ampl4.proxy.deleteResourcesOfReleaseByIdOfProjectById(resourcesToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        assertFalse(o_testAddDeleteResourcesOfReleaseByIdOfProjectById_add7469__1.isEmpty());
        assertTrue(o_testAddDeleteResourcesOfReleaseByIdOfProjectById_add7469__12);
    }
    ...
    public void testAddDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber7502_failAssert0() throws Exception {
        try {
            ...
            Assert.notNull(release);
            Assert.notNull(release);
            release = ReplanControllerProxyTest_Ampl4.proxy.deleteResourcesOfReleaseByIdOfProjectById(resourcesToAdd, releases.get(1).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteFeaturesOfReleaseByIdOfProjectById_add2049() throws Exception {
        List<Feature> o_testAddDeleteFeaturesOfReleaseByIdOfProjectById_add2049__1 = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        ...
        HttpStatus o_testAddDeleteFeaturesOfReleaseByIdOfProjectById_add2049__14 = ReplanControllerProxyTest_Ampl4.proxy.addFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        ...
        HttpStatus o_testAddDeleteFeaturesOfReleaseByIdOfProjectById_add2049__17 = ReplanControllerProxyTest_Ampl4.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteFeaturesOfReleaseByIdOfProjectById_add2055() throws Exception {
        ...
        HttpStatus o_testAddDeleteFeaturesOfReleaseByIdOfProjectById_add2055__15 = ReplanControllerProxyTest_Ampl4.proxy.addFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        ...
        HttpStatus o_testAddDeleteFeaturesOfReleaseByIdOfProjectById_add2055__18 = ReplanControllerProxyTest_Ampl4.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteFeaturesOfReleaseByIdOfProjectById_literalMutationNumber2070() throws Exception {
        ...
        HttpStatus o_testAddDeleteFeaturesOfReleaseByIdOfProjectById_literalMutationNumber2070__14 = ReplanControllerProxyTest_Ampl4.proxy.addFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        ...
        HttpStatus o_testAddDeleteFeaturesOfReleaseByIdOfProjectById_literalMutationNumber2070__17 = ReplanControllerProxyTest_Ampl4.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteFeaturesOfReleaseByIdOfProjectById_remove2067_failAssert0() throws Exception {
        try {
            ...
            Assert.notEmpty(releases);
            List<Feature> featuresToAdd = new ArrayList<>();
            ReplanControllerProxyTest_Ampl4.proxy.addFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
            ReplanControllerProxyTest_Ampl4.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteFeaturesOfReleaseByIdOfProjectById_literalMutationNumber2078_failAssert0() throws Exception {
        try {
            ...
            ReplanControllerProxyTest_Ampl4.proxy.addFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
            ReplanControllerProxyTest_Ampl4.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(1).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteFeaturesOfReleaseByIdOfProjectByIdlitNum2100_failAssert0() throws Exception {
        try {
            ...
            featuresToAdd.add(features.get(0));
            ReplanControllerProxyTest_Ampl4.proxy.addFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
            ReplanControllerProxyTest_Ampl4.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(-1804336248).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteFeaturesOfReleaseByIdOfProjectById_add2055_add2432() throws Exception {
        ...
        Assert.notNull(features);
        Assert.notEmpty(features);
        List<Release> o_testAddDeleteFeaturesOfReleaseByIdOfProjectById_add2055_add2432__5 = ReplanControllerProxyTest_Ampl4.proxy.getReleasesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        ...
        try {
            {
                ...
                List<Feature> featuresToAdd = new ArrayList<>();
                ReplanControllerProxyTest_Ampl4.proxy.addFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
                ReplanControllerProxyTest_Ampl4.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(Integer.MAX_VALUE).getId(), ReplanControllerProxyTest_Ampl4.projectId);
                org.junit.Assert.fail("testAddDeleteFeaturesOfReleaseByIdOfProjectById_remove2067 should have thrown IllegalArgumentException");
            }
    ...
    public void testAddDeleteSkillOfProjectById_add9749() throws Exception {
        ...
        skill = ReplanControllerProxyTest_Ampl4.proxy.addSkillOfProjectById(skill, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(skill);
        HttpStatus o_testAddDeleteSkillOfProjectById_add9749__9 = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillByIdOfProjectById(skill.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteSkillOfProjectById_add9753() throws Exception {
        ...
        skill = ReplanControllerProxyTest_Ampl4.proxy.addSkillOfProjectById(skill, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(skill);
        HttpStatus o_testAddDeleteSkillOfProjectById_add9753__8 = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillByIdOfProjectById(skill.getId(), ReplanControllerProxyTest_Ampl4.projectId);
        ...
        HttpStatus o_testAddDeleteSkillOfProjectById_add9753__10 = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillByIdOfProjectById(skill.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteSkillOfProjectByIdnull9804_failAssert0() throws Exception {
        try {
            ...
            skill.setName("Atos test: Swift");
            skill.setDescription("Atos Test: Swift development of iOS");
            skill = ReplanControllerProxyTest_Ampl4.proxy.addSkillOfProjectById(null, ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notNull(skill);
            ReplanControllerProxyTest_Ampl4.proxy.deleteSkillByIdOfProjectById(skill.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteResourceOfProjectById_add4927() throws Exception {
        ...
        resource = ReplanControllerProxyTest_Ampl4.proxy.addResourceOfProjectById(resource, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(resource);
        HttpStatus o_testAddDeleteResourceOfProjectById_add4927__10 = ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteResourceOfProjectById_add4932() throws Exception {
        ...
        resource = ReplanControllerProxyTest_Ampl4.proxy.addResourceOfProjectById(resource, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(resource);
        HttpStatus o_testAddDeleteResourceOfProjectById_add4932__9 = ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
        ...
        HttpStatus o_testAddDeleteResourceOfProjectById_add4932__11 = ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteResourceOfProjectById_mg4956() throws Exception {
        ...
        resource = ReplanControllerProxyTest_Ampl4.proxy.addResourceOfProjectById(resource, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(resource);
        HttpStatus o_testAddDeleteResourceOfProjectById_mg4956__12 = ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteResourceOfProjectByIdnull5012_failAssert0() throws Exception {
        try {
            ...
            resource.setDescription("Atos Test: Swift developer with experience on iOS 10");
            resource.setAvailability(80.0);
            resource = ReplanControllerProxyTest_Ampl4.proxy.addResourceOfProjectById(null, ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notNull(resource);
            ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteResourceOfProjectById_mg4956_add5379() throws Exception {
        ...
        resource = ReplanControllerProxyTest_Ampl4.proxy.addResourceOfProjectById(resource, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(resource);
        HttpStatus o_testAddDeleteResourceOfProjectById_mg4956_add5379__12 = ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testAddDeleteSkillsOfResourceByIdOfProjectById_add13120() throws Exception {
        List<Skill> o_testAddDeleteSkillsOfResourceByIdOfProjectById_add13120__1 = ReplanControllerProxyTest_Ampl4.proxy.getSkillsOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        ...
        Resource resource = ReplanControllerProxyTest_Ampl4.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(resource);
        Assert.notNull(resource);
        resource = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillsOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        assertFalse(o_testAddDeleteSkillsOfResourceByIdOfProjectById_add13120__1.isEmpty());
        assertTrue(o_testAddDeleteSkillsOfResourceByIdOfProjectById_add13120__12);
    }
    ...
    public void testAddDeleteSkillsOfResourceByIdOfProjectById_literalMutationNumber13153_failAssert0() throws Exception {
        try {
            ...
            Assert.notNull(resource);
            Assert.notNull(resource);
            resource = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillsOfResourceByIdOfProjectById(skillsToAdd, resources.get(1).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testDeleteSkillsOfFeatureByIdOfProjectById_add33842() throws Exception {
        ...
        feature = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), ReplanControllerProxyTest_Ampl4.projectId);
        assertTrue(o_testDeleteSkillsOfFeatureByIdOfProjectById_add33842__16);
        assertTrue(o_testDeleteSkillsOfFeatureByIdOfProjectById_add33842__18);
    }
    ...
    public void testDeleteFeaturesOfReleaseByIdOfProjectById_add22648() throws Exception {
        List<Feature> o_testDeleteFeaturesOfReleaseByIdOfProjectById_add22648__1 = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        ...
        HttpStatus o_testDeleteFeaturesOfReleaseByIdOfProjectById_add22648__14 = ReplanControllerProxyTest_Ampl4.proxy.addFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        ...
        List<Feature> featuresOfRelease = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfReleaseByIdOfProjectById(releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        ...
        HttpStatus o_testDeleteFeaturesOfReleaseByIdOfProjectById_add22648__29 = ReplanControllerProxyTest_Ampl4.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToDelete, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        ...
        featuresOfRelease = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfReleaseByIdOfProjectById(releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testDeleteFeaturesOfReleaseByIdOfProjectById_add22665() throws Exception {
        ...
        HttpStatus o_testDeleteFeaturesOfReleaseByIdOfProjectById_add22665__13 = ReplanControllerProxyTest_Ampl4.proxy.addFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        ...
        HttpStatus o_testDeleteFeaturesOfReleaseByIdOfProjectById_add22665__30 = ReplanControllerProxyTest_Ampl4.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToDelete, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testDeleteFeaturesOfReleaseByIdOfProjectById_remove22676() throws Exception {
        ...
        HttpStatus o_testDeleteFeaturesOfReleaseByIdOfProjectById_remove22676__12 = ReplanControllerProxyTest_Ampl4.proxy.addFeaturesOfReleaseByIdOfProjectById(featuresToAdd, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
        ...
        HttpStatus o_testDeleteFeaturesOfReleaseByIdOfProjectById_remove22676__27 = ReplanControllerProxyTest_Ampl4.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToDelete, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testDeleteFeaturesOfReleaseByIdOfProjectById_remove22683_failAssert0() throws Exception {
        try {
            ...
            int numberOfFeaturesOfRelease = featuresOfRelease.size();
            List<Feature> featuresToDelete = new ArrayList<>();
            ReplanControllerProxyTest_Ampl4.proxy.deleteFeaturesOfReleaseByIdOfProjectById(featuresToDelete, releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
            featuresOfRelease = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfReleaseByIdOfProjectById(releases.get(0).getId(), ReplanControllerProxyTest_Ampl4.projectId);
            Assert.notNull(features);
            Assert.isTrue(((featuresOfRelease.size()) == (numberOfFeaturesOfRelease - 1)));
    ...
    public void testDeleteFeaturesOfReleaseByIdOfProjectById_add22665_add23228() throws Exception {
        List<Feature> o_testDeleteFeaturesOfReleaseByIdOfProjectById_add22665_add23228__1 = ReplanControllerProxyTest_Ampl4.proxy.getFeaturesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testDeleteResourceOfProjectById_add27781() throws Exception {
        ...
        resource = ReplanControllerProxyTest_Ampl4.proxy.addResourceOfProjectById(resource, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(resource);
        HttpStatus o_testDeleteResourceOfProjectById_add27781__10 = ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testDeleteResourceOfProjectById_add27786() throws Exception {
        ...
        resource = ReplanControllerProxyTest_Ampl4.proxy.addResourceOfProjectById(resource, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(resource);
        HttpStatus o_testDeleteResourceOfProjectById_add27786__9 = ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
        ...
        HttpStatus o_testDeleteResourceOfProjectById_add27786__11 = ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testDeleteResourceOfProjectById_mg27815() throws Exception {
        ...
        resource = ReplanControllerProxyTest_Ampl4.proxy.addResourceOfProjectById(resource, ReplanControllerProxyTest_Ampl4.projectId);
        Assert.notNull(resource);
        HttpStatus o_testDeleteResourceOfProjectById_mg27815__12 = ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testDeleteResourceOfProjectById_mg27815_add28247null29694_failAssert0() throws Exception {
        try {
            ...
            Assert.notNull(null);
            HttpStatus o_testDeleteResourceOfProjectById_mg27815__12 = ReplanControllerProxyTest_Ampl4.proxy.deleteResourceByIdOfProjectById(resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
            List<Resource> o_testDeleteResourceOfProjectById_mg27815_add28247__16 = ReplanControllerProxyTest_Ampl4.proxy.getResourcesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
            List<Resource> resources = ReplanControllerProxyTest_Ampl4.proxy.getResourcesOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
            Assert.isTrue((!(containsId(resources, resource.getId()))));
            resource.setSkills(__DSPOT_skills_715);
    ...
    public void testDelecteSkillsOfResourceByIdOfProjectById_add18324() throws Exception {
        List<Skill> o_testDelecteSkillsOfResourceByIdOfProjectById_add18324__1 = ReplanControllerProxyTest_Ampl4.proxy.getSkillsOfProjectById(ReplanControllerProxyTest_Ampl4.projectId);
        ...
        resource = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillsOfResourceByIdOfProjectById(skillsToAdd, resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
    ...
    public void testDelecteSkillsOfResourceByIdOfProjectByIdnull18420_failAssert0() throws Exception {
        try {
            ...
            int numberOfSkills = resource.getSkills().size();
            resource = ReplanControllerProxyTest_Ampl4.proxy.deleteSkillsOfResourceByIdOfProjectById(null, resource.getId(), ReplanControllerProxyTest_Ampl4.projectId);
            Assert.isTrue(((resource.getSkills().size()) == (numberOfSkills - 1)));
