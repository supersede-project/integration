...
public class IFTenantsManagerTest_Ampl4 {
    ...
    public static void setup() throws Exception {
        ...
        IFTenantsManagerTest_Ampl4.tm = new IFTenantsManager(admin, password);
    }

    @Test(timeout = 30000)
    public void getAllTenantsTest_add4() throws Exception {
        List<TenantInfoBean> tenants = IFTenantsManagerTest_Ampl4.tm.getAllTenants();
