...
//	public Application updateApplication(Application app) throws Exception;
	...
	public GeneralConfiguration updateGeneralConfigurations(GeneralConfiguration generalConfiguration) throws Exception;
	...
	public FeedbackMechanism insertFeedbackMechanismForConfigurationById(Integer id, FeedbackMechanism feedbackMechanism) throws Exception;
	public FeedbackMechanism updateFeedbackMechanismForConfigurationById(Integer id, FeedbackMechanism feedbackMechanism) throws Exception;
	...
	public FeedbackParameter insertFeedbackParameterForGeneralConfigurationById(Integer id, FeedbackParameter feedbackParameter) throws Exception;
	public FeedbackParameter insertFeedbackParameterForFeedbackMechanismById(Integer id, FeedbackParameter feedbackParameter) throws Exception;
